...
export default function FuelStationModal() {
  ...
  const stationCodeLoggedIn = 'ST001';
  ...
  const confirmDispense = () => {
    ...
    const product = mockProducts[stationCodeLoggedIn].find(p => p.type === selectedProduct);
  ...
  const renderLogin = () => (
    <ThemedView style={styles.container}>
      <ThemedText type="title" style={styles.title}>BiDi Fuel - Station Login</ThemedText>
      <TextInput
        style={styles.input}
    ...
    <ScrollView style={styles.container}>
      ...
      {!tokenDetails ? (
        ...
        <>
          ...
          <ThemedText>Station: {mockStations[stationCodeLoggedIn]?.name}</ThemedText>
          ...
          <FlatList
            data={mockProducts[stationCodeLoggedIn]}
